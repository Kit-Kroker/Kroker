...
│   ├── dashboard/             # fleet poller, REST + SSE api, channel adapter (E-10); graph_wire + graph routes (E-76); run graph/state routes, run_graph source (E-75); graph store + save/load routes (E-77)
