# Clarifier rubric — todo-api-greenfield
...
- **scope_discipline (0.3):** out_of_scope is explicit and reasonable (e.g.
  no auth, no multi-user, no pagination unless flagged)
