...
_SECRET_KEYWORD_RE = re.compile(rf"(?:^|[_$-])(?:{_SECRET_KEYWORD})(?:[_$-]|$)", re.IGNORECASE)
...
def _is_env_file(path: str) -> bool:
    ...
    return base == ".env" or (base.startswith(".env.") and base not in _ENV_EXAMPLES)
