...
SIGNALS: dict[str, SignalSpec] = {
    ...
    dependencies.SIGNAL_ID: SignalSpec(
        id=dependencies.SIGNAL_ID, version=dependencies.VERSION, activity="triage_dependencies"
    ),
    scaffold.SIGNAL_ID: SignalSpec(
        id=scaffold.SIGNAL_ID,
        version=scaffold.VERSION,
        activity="triage_scaffold",
        readiness_keys=(M_STRUCTURE,),
    ),
    misconfig.SIGNAL_ID: SignalSpec(
        id=misconfig.SIGNAL_ID, version=misconfig.VERSION, activity="triage_misconfig"
    ),
    outliers.SIGNAL_ID: SignalSpec(
        id=outliers.SIGNAL_ID, version=outliers.VERSION, activity="triage_outliers"
    ),
}
