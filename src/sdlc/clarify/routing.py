...
SUPERVISOR_DIMENSIONS: tuple[CD, ...] = (CD.FUNCTIONAL_INTENT,
...
PROBE_DIMENSIONS: tuple[CD, ...] = (CD.TECHNICAL_CONTEXT, CD.INTERFACE_SPEC,
...
_GREENFIELD_SKIP: frozenset[CD] = frozenset({CD.TECHNICAL_CONTEXT,
                                             CD.CODE_STRUCTURE})
...
def live_dimensions(requested: Iterable[CD],
                    mode: ProjectMode) -> tuple[CD, ...]:
